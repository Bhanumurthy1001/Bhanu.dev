        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>BUILD</h3>
              <h4>Data and AI infrastructure</h4>
              <p>
                I build ingestion pipelines, backend APIs, and AI workflows
                that move data from external sources into reliable products and
                model-ready systems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>OPERATE</h3>
              <h4>Cloud, automation, and reliability</h4>
              <p>
                I containerize services, automate infrastructure, tune
                performance, and keep systems observable, secure, and ready for
